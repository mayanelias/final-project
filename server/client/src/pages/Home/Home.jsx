...
import HomeVideo from "../../../src/videos/home.mp4";
import TopTenArtists from "../../components/topTenArtists/TopTenArtists";
...
const Home = ({
  ...
  let filteredElements = data.filter(
    ...
    let elements = filteredElements.slice(0, 9).map((concert) => {
  ...
  return (
        <><video className={style.homeVideo} src={HomeVideo} autoPlay loop muted /><div className={style.search}>
      ...
      <br />
      <button className={style.moveToConcerts} onClick={() => { setConcertsRedirect(true); } }>For More Concerts</button>
      <br />
      <br />
      <TopTenArtists setTopTenArtistsDetails={setTopTenArtistsDetails} data={data}/>
    </div>
    <Contact/>
    </>
